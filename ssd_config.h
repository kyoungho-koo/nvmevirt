...
#define RU_PER_RG (4096)
#define LINES_PER_RU (2)
#define RU_PER_FTL (RG_PER_FTL * RU_PER_RG)
#define RECLAIM_UNITS (RECLAIM_GROUPS * RU_PER_RG)
#define RU_CHANNELS (2)
#define CH_PER_FTL (NAND_CHANNELS / SSD_PARTITIONS)
#define LUN_PER_FTL (CH_PER_FTL * LUNS_PER_NAND_CH)
